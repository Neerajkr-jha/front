      ...
      <form className="flex flex-col gap-4 w-full " onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col w-full">
          ...
          <input
            ...
            className="border border-black-400 rounded px-2 py-1 w-full utline-none focus:outline-none focus:ring-0 bg-white"
          />
        </div>
        <div className="flex flex-col w-full">
          ...
          <input
            ...
            onChange={handleChange}
            className="border border-black-400 rounded px-2 py-2 w-full outline-none focus:outline-none focus:ring-0 bg-white"
          />
        </div>
